# any functionlaity that are used commanly is written here
'''
ex:
    reading the data from database we can create database client here
    saving model to cloude
'''
...
def evaluate_model(X_train, X_test,y_train,y_test, models,hyper_patrameter):
    ...
    try:
        ...
        raise CustomException(e,sys)
# load_obj function is responsible for laoding the pickle file
